        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-3 px-4 py-3.5 sm:gap-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-2 lg:gap-3">
            <a
              ...
              className="hidden rounded-full p-2 text-charcoal/70 transition-colors hover:bg-sage-50 hover:text-sage-600 sm:inline-flex"
            >
              <Icon name="instagram" />
            </a>
            <a
      ...
      >
        <nav className="flex flex-col gap-1 px-6 pt-24">
          ...
          <a
            ...
            rel="noopener noreferrer"
            onClick={() => setMenuOpen(false)}
            className="mt-3 inline-flex items-center justify-center gap-2 rounded-full border border-sage-200 py-3.5 text-sm font-semibold text-charcoal"
          >
