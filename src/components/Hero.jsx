...
export default function Hero() {
  return (
    <section className="relative min-h-[72vh] overflow-hidden sm:min-h-[80vh] lg:min-h-[88vh]">
      ...
      <div className="relative mx-auto grid min-h-[72vh] max-w-7xl items-center gap-8 px-4 py-14 sm:min-h-[80vh] sm:gap-12 sm:px-6 sm:py-20 lg:min-h-[88vh] lg:grid-cols-2 lg:gap-16 lg:px-8 lg:py-28">
        <div className="max-w-xl">
          <div className="animate-fade-up mb-4 flex items-center gap-2.5 sm:mb-6 sm:gap-3">
            <img
              src={LOGO_URL}
              alt=""
              className="h-10 w-10 rounded-full object-cover ring-2 ring-cream/30 sm:h-12 sm:w-12"
            />
            <p className="text-[10px] font-semibold uppercase tracking-[0.28em] text-sage-200 sm:text-xs sm:tracking-[0.35em]">
              Inspired by Nature
            </p>
          </div>
          <h1 className="animate-fade-up-delay-1 font-display text-4xl font-medium leading-[1.1] text-white sm:text-5xl sm:leading-[1.08] lg:text-[3.5rem]">
            Lifelike decor,
            <br />
            <span className="italic text-sage-200">effortlessly elegant</span>
          </h1>
          <p className="animate-fade-up-delay-2 mt-4 text-sm leading-relaxed text-cream/85 sm:mt-6 sm:text-base lg:text-lg">
          ...
          <div className="animate-fade-up-delay-2 mt-8 flex flex-col gap-3 sm:mt-10 sm:flex-row sm:flex-wrap sm:gap-4">
            <a
              href="#shop"
              className="inline-flex items-center justify-center rounded-full bg-sage-500 px-6 py-3 text-sm font-semibold text-white transition-all hover:bg-sage-400 hover:shadow-lg sm:px-8 sm:py-3.5"
            >
              Shop Collection
            </a>
            <a
              ...
              className="inline-flex items-center justify-center gap-2 rounded-full border border-cream/30 bg-cream/10 px-6 py-3 text-sm font-semibold text-white backdrop-blur-sm transition-all hover:bg-cream/20 sm:px-8 sm:py-3.5"
            >
          ...
          <div className="animate-fade-up-delay-2 mt-8 flex flex-col gap-2 sm:mt-12 sm:flex-row sm:flex-wrap sm:gap-x-8 sm:gap-y-3">
            {highlights.map((item) => (
              <span
                key={item}
        ...
        {featuredFlowers.length > 0 && (
          <div className="hidden gap-5 lg:grid lg:grid-cols-2 lg:gap-6">
